  ...
  _createClass(Signup, [{
    ...
    value: function handleOnSubmit(e) {
      ...
      _firebaseBrowser2.default.auth().createUserWithEmailAndPassword(email, password).then(function (newUser) {
        newUser.updateProfile({ displayName: name, photoURL: photoURL });
      }).then(function () {
        history.push('/rooms');
      }).catch(function (err) {
        _this2.setState({
    ...
    value: function render() {
      return _react2.default.createElement(
        'form',
        { action: '', style: SIGNUP_FORM_STYLE, onSubmit: this.handleOnSubmit },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'user name', onChange: this.handleOnChangeName, value: this.state.name })
        ),
        _react2.default.createElement(
          'div',
          { className: 'form-group' },
          ...
          _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'photo URL', onChange: this.handleOnChangePhotoURL, value: this.state.photoURL })
        ),
        _react2.default.createElement(
          'div',
          { className: 'form-group' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'btn btn-large btn-debtn-default', style: CANCEL_BUTTON_STYLE, type: 'button' },
              'Cancel'
            )
          )
        )
